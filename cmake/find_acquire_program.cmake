## # find_acquire_program
##
## Download or find a well-known tool.
##
## ## Usage
## ```cmake
## find_acquire_program(<VAR>)
## ```
## ## Parameters
## ### VAR
...
function(find_acquire_program VAR)
  ...
  get_program_files_platform_bitness(PROGRAM_FILES_PLATFORM_BITNESS)
  get_program_files_32_bit(PROGRAM_FILES_32_BIT)
  ...
  macro(do_find)
    if(NOT DEFINED REQUIRED_INTERPRETER)
      ...
      find_acquire_program(${REQUIRED_INTERPRETER})
